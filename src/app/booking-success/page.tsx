...
export default function BookingSuccessPage({
  ...
  return (
    <section className="card max-w-2xl">
      <h1 className="text-2xl font-bold text-green-700">報名已送出</h1>
      <p className="mt-2 text-sm text-slate-600">
        感謝你的申請，報名預設會是「待確認」，我們會盡快回覆。
      </p>
      ...
      <div className="mt-4 space-y-2 text-sm">
        ...
        <p>會員資格：{searchParams.isMember ?? "-"}</p>
        <p>金額：{searchParams.price ? `${searchParams.price} 元` : "-"}</p>
      </div>
